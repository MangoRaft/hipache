(function() {
    ...
    var IDriver = require('../utils/idriver'), DriverError = require('../utils/drivererror'), redis = require('redis'),
    ...
    var Redis = function() {
        ...
        this.sni = function(host, callback) {
            client.hgetall(prefix + host, callback);
        };
